...
import 'package:time_tracker_flutter_course/pages/entries/daily_jobs_details.dart';
import 'package:time_tracker_flutter_course/pages/entries/entries_list_tile.dart';
import 'package:time_tracker_flutter_course/pages/entries/entry_job.dart';
...
class EntriesBloc {
  ...
  static List<EntryJob> _entriesJobsCombiner(
      ...
      print("_entriesJobsCombiner: entries: $entries, jobs: $jobs");
